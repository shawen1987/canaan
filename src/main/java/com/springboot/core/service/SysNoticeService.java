...
import com.springboot.core.mapper.auto.SysNoticeMapper;
import com.springboot.core.mapper.auto.SysNoticeUserMapper;
import com.springboot.core.model.auto.*;
import com.springboot.core.model.auto.SysNoticeUserExample.Criteria;
	 ...
	 */
	 public PageInfo<SysNotice> list(TsysUser tsysUser,Tablepar tablepar,String name){
			...
			if(noticeUsers!=null&&noticeUsers.size()>0) {
		        ...
		        com.springboot.core.model.auto.SysNoticeExample.Criteria criteria1= testExample.createCriteria();
		        if(name!=null&&!"".equals(name)){
