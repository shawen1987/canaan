...
public class SysFaceExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andUpdateUserNotBetween(String value1, String value2) {
		 ...
		 public Criteria andLikeQuery(SysFace record) {
			...
			if(record.getEigen()!=null&&StrUtil.isNotEmpty(record.getEigen().toString())) {
    			 list.add("ifnull(eigen,'')");
    		}
